    ...
    public function run() {
        ...
        $menus = [
            ...
            ['middleware' => 'auth|verified', 'children' => [
                ...
                ['name' => 'Kelas Saya', 'url' => 'me/course/{course}', 'route' => 'front.me.course.lesson', 'component' => 'front/me/course/Video'],
                ['name' => 'Kelas Saya', 'url' => 'me/course/{course}/{lesson}/{video}', 'route' => 'front.me.course.lesson.video', 'component' => 'front/me/course/Video'],
                ...
                ['middleware' => 'role:admin', 'children' => [
                    ...
                    ['name' => 'Laporan', 'heading' => true],
                    ['name' => 'Transaksi', 'url' => 'dashboard/admin/transaction', 'route' => 'dashboard.admin.transaction', 'component' => 'dashboard/admin/transaction/Index', 'icon' => 'las la-credit-card fs-2'],
